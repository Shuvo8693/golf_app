class ApiConstants {
  ...
  static String baseUrl =
      "https://wn85j8p6-9090.asse.devtunnels.ms/v1"; // Server
  ...
  static String googleApiKey =
      "AIzaSyBI8fHu17r7bJcDz4eV8MdiVOIbYVG6fTI"; //client
  ...
  static String myTournamentShowingUrl =
      '$baseUrl/looking-toplay/show-tournament';
  ...
  static String smallTournamentUrl =
      '$baseUrl/small-tournament/getAll-small-tournament';
  ...
  static String smallOutingRequestToPlayUrl(dynamic tournamentId) =>
      '$baseUrl/small-tournament/makerequest-toplay';
  static String teeSheetUrl(String tournamentId, String tournamentType) =>
      '$baseUrl/teeSheet?id=$tournamentId&type=$tournamentType';
  static String winnersUrl(dynamic completeTourId) =>
      '$baseUrl/winner?id=$completeTourId';
  static String winnersConfirmationUrl(String completeTourId) =>
      '$baseUrl/winner?id=$completeTourId';
  static String postWinnersUrl(String sectionName) =>
      '$baseUrl/winner-$sectionName';
  static String updateSkinUrl = '$baseUrl/winner-skin';
  static String golfersNameUrl(String name) =>
      '$baseUrl/users/showgolfer?name=$name';
  static String golfersNameDirectUrl = '$baseUrl/users/showgolfer';
  static String messageUrl = '$baseUrl/chat-room';
  static String playerListUrl(String tournamentId, String sectionName) =>
      '$baseUrl/winner-$sectionName/allUser?id=$tournamentId';
  static String markAsReadNotificationUrl(dynamic notificationId) =>
      '$baseUrl/notification?id=$notificationId';
  static String invitationDeleteUrl(dynamic invitationId) =>
      '$baseUrl/invitation/delete?id=$invitationId';
  static String invitationAcceptUrl(dynamic invitationId) =>
      '$baseUrl/invitation/accept?id=$invitationId';
  static String requestToPlayApprovedUrl(dynamic id) =>
      '$baseUrl/request-to-play?id=$id';
  static String requestToPlayRejectUrl(dynamic id) =>
      '$baseUrl/request-to-play/cancleRequest?id=$id';
  static String userProfileByIdUrl(dynamic userID) => '$baseUrl/users/$userID';
  static String challengeDeleteUrl(dynamic challengeId) =>
      '$baseUrl/chaleng?id=$challengeId';
  static String requestToPlaylistUrl(String type, int page, int limit) =>
      '$baseUrl/request-to-play?typename=big&page=$page&limit=$limit';
  static String tournamentDetailsUrl(String type, String tournamentId) =>
      '$baseUrl/entered/details?id=$tournamentId&type=$type';
  static String tournamentPlayerUrl(String type, String tournamentId) =>
      '$baseUrl/teeSheet/showTournamentById?id=$tournamentId&typeName=$type';
  static String showAllPlayerUrl(String type, String tournamentId) =>
      '$baseUrl/chaleng/showAllplayer?type=$type&id=$tournamentId';
  static String showAllMatchesUrl(String type, String tournamentId) =>
      '$baseUrl/chaleng?id=$tournamentId&type=$type';
  static String tournamentCompletionStatusUrl(
          String type, String tournamentId) =>
      '$baseUrl/small-tournament/make-tournament-complete?id=$tournamentId&type=$type';
...
//===================X===============================================
  ...
  static String getMessageUrl(String chatId) =>
      '$baseUrl/message?chatid=$chatId';
  static String updateGroupChatUrl(dynamic chatId) =>
      '$baseUrl/chat?id=$chatId';
  static String deleteGroupUrl(dynamic groupId) => '$baseUrl/group/$groupId';
  static String inviteFriendUrl(dynamic groupId) =>
      '$baseUrl/group/all-invite-friend?groupId=$groupId';
  static String updateGroupUrl(dynamic groupId) =>
      '$baseUrl/group/update/$groupId';
  static String groupSearchResultUrl(String name) =>
      '$baseUrl/group/search?name=$name';
  static String searchMyFriendListUrl(String name) =>
      '$baseUrl/friend/friends?fullName=$name';
  static String searchMyGroupChatMemberListUrl(String name) =>
      '$baseUrl/chat/group/all-member?fullName=$name';
  static String groupJoinUrl(dynamic groupId) =>
      '$baseUrl/group/join?groupId=$groupId';
  static String leaveGroupUrl(dynamic groupId) =>
      '$baseUrl/group/left?groupId=$groupId';
  static String acceptFriendRequestUrl(dynamic requestId) =>
      '$baseUrl/friend/accept?requestId=$requestId';
  static String removeFriendUrl(dynamic friendId) =>
      '$baseUrl/friend/remove?friendId=$friendId';
  ...
  static String likeUrl(dynamic postId) =>
      '$baseUrl/post/like-toggle?postId=$postId';
  static String getCommentsUrl(dynamic postId) =>
      '$baseUrl/post/comments?postId=$postId';
  static String postCommentsUrl(dynamic postId) =>
  ...
  static String sendFriendRequestUrl(dynamic postId) =>
      '$baseUrl/friend/request?receiverId=$postId';
  static String searchNameUrl(String name) => '$baseUrl/users?fullName=$name';
  static String accountDeleteUrl(String userId) =>
      '$baseUrl/users/delete?userId=$userId';
}
