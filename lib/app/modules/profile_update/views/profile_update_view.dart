  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((__) async {
      ...
      _profileUpdateController =
          Get.put(ProfileUpdateController(user: myProfileCtrl.myProfile.value));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _profileUpdateController == null
          ? const Center(
              child:
                  CircularProgressIndicator(), // Show a loading state while initializing
            )
                        ...
                        Obx(() {
                          return Positioned(
                            child: _profileUpdateController!
                                ...
                                : CustomNetworkImage(
                                    imageUrl:
                                        '${ApiConstants.imageBaseUrl}${myProfileCtrl.myProfile.value.coverImage?.url}',
                                    height: 200.h,
                                  ),
                          );
                        }),
                        ...
                        Obx(() {
                          return Positioned(
                            ...
                            child: _profileUpdateController!
                                ...
                                : CustomNetworkImage(
                                    imageUrl:
                                        '${ApiConstants.imageBaseUrl}${myProfileCtrl.myProfile.value.image?.url}',
                                    height: 125.h,
                                    width: 125.h,
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (newValue) {
                            ...
                            print(
                                'Gender>>>${_profileUpdateController!.gender}');
                          },
                        ),
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: CustomTextField(
                                    ...
                                    controller: _profileUpdateController!
                                        .clubHandicapCtrl,
                                  ),
                                ),
                              ],
                        ...
                        CustomTextField(
                          ...
                          labelTextStyle:
                              TextStyle(color: AppColors.primaryColor),
                          controller:
                              _profileUpdateController!.faceBookLinkCtrl,
                        ),
                        ...
                        CustomTextField(
                          ...
                          labelTextStyle:
                              TextStyle(color: AppColors.primaryColor),
                          controller:
                              _profileUpdateController!.instagramLinkCtrl,
                        ),
