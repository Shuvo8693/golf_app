...
class CreateLookingToPlayView extends StatefulWidget {
  ...
  @override
  State<CreateLookingToPlayView> createState() =>
      _CreateLookingToPlayViewState();
}

class _CreateLookingToPlayViewState extends State<CreateLookingToPlayView> {
  final CreateLookingToPlayController _createLookingToPlayController =
      Get.put(CreateLookingToPlayController());
            ...
            child: Column(
              ...
              children: [
                Align(
                  ...
                  child: Text(AppString.createLookingToPlayText,
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _createLookingToPlayController.categoryList
                      .map(
                  ...
                  onChanged: (newValue) {
                    setState(() {
                      ...
                      print(
                          'Category>>>${_createLookingToPlayController.category}');
                    });
                  },
                ),
                ...
                /// Visiting From
                SizedBox(height: 10.h),
                Text(AppString.visitingFromText,
                    style: AppStyles.h4(family: "Schuyler")),
                SizedBox(height: 10.h),
                ...
                SizedBox(height: 10.h),
                Text(
                    '${AppString.golfCourseText}  (Leave blank for any course)',
                    style: AppStyles.h4(family: "Schuyler")),
                SizedBox(height: 10.h),
                ...
                /// from Date
                SizedBox(height: 10.h),
                Text(AppString.fromText,
                    style: AppStyles.h4(family: "Schuyler")),
                SizedBox(height: 10.h),
                Obx(
                  () => GestureDetector(
                    onTap: () async {
                      await _createLookingToPlayController
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              _createLookingToPlayController
                  ...
                  return CustomButton(
                    ...
                    onTap: () {
                      if (_formKey.currentState!.validate() &&
                          ...
                          _createLookingToPlayController
                              .selectedFromDate.value.isNotEmpty) {
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        if (selectedLocation.isNotEmpty == true) {
                          ...
                          if (isGolfCourse == true) {
                            _createLookingToPlayController.golfCourseCtrl.text =
                                selectedLocation;
                          } else {
                            _createLookingToPlayController
                                .visitingFromCtrl.text = selectedLocation;
                          }

                          await _createLookingToPlayController
                              .goToSearchLocation(selectedLocation);
                        }
