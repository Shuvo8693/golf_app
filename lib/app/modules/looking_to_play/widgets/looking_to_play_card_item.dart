...
class LookingToPlayCardItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    DateTime dateTimeFrom =
        DateFormat("dd/MM/yyyy").parse(lookingToPlayAttributes.fromDate!);
    DateTime dateTimeTo =
        DateFormat("dd/MM/yyyy").parse(lookingToPlayAttributes.tomDate!);
    return CustomCard(
      padding: 7.sp,
        ...
        Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                    '${AppString.userNameText} : ${lookingToPlayAttributes.userName}',
                      ...
                      PopupMenuItem(
                        ...
                        onTap: () {
                          ...
                          Get.toNamed(Routes.USER_PROFILE, arguments: {
                            'receiverId': lookingToPlayAttributes.player
                          });
                        },
                      )
                    ];
            ...
            SizedBox(height: 10.h),
            Text(
                '${AppString.golfCourseText} : ${lookingToPlayAttributes.golfCourse} ',
                overflow: TextOverflow.ellipsis,
                style: AppStyles.h4()),
            SizedBox(height: 10.h),
            Text(
                '${AppString.dateRangeText} : ${DateFormat("MMM dd, yyyy").format(dateTimeFrom)} to ${DateFormat("MMM dd, yyyy").format(dateTimeTo)}',
                overflow: TextOverflow.ellipsis,
                style: AppStyles.h4()),
            SizedBox(height: 10.h),
            Row(
