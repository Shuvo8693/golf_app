...
class _AddSmallOutingViewState extends State<AddSmallOutingView> {
  final AddSmallOutingController _addSmallOutingController = Get.put(AddSmallOutingController());
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: CustomTextField(
                          ...
                          controller: _addSmallOutingController.courseRatingCtrl,
                        ),
                      ),
                    ],
                  ),
              ...
              /// From range
              SizedBox(height: 10.h),
              Text(AppString.fromRangeText, style: AppStyles.h4(family: "Schuyler")),
              SizedBox(height: 10.h),
              CustomTextField(
                  keyboardType: TextInputType.number,
                  contentPaddingVertical: 12.h,
              ...
              DropdownButtonFormField<String>(
                /// Dropdown button field======================<<<<<<<<
                value: _addSmallOutingController.groupNumber,
                padding: EdgeInsets.zero,
                hint: Text("Select Number of player"),
                decoration: InputDecoration(),
                items: _addSmallOutingController.groupNumberList
                    .map(
                      (gender) => DropdownMenuItem<String>(
                        value: gender,
                        child: Text(gender),
                ...
                onChanged: (newValue) {
                  setState(() {
                    _addSmallOutingController.groupNumber = newValue;
                    print(
                        'Player Number >>>${_addSmallOutingController.groupNumber}');
                  });
                },
              ),
