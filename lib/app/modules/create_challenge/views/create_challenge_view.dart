...
class _CreateChallengeViewState extends State<CreateChallengeView> {
  final CreateChallengeController _createChallengeController =
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((__) async {
      ...
      if (tournamentDetailAttributes != null) {
        await _createChallengeController.fetchTournamentPlayer(
  ...
  getTournamentDetails() {
    final tournamentDetails =
        Get.arguments['tournamentDetails'] as TournamentDetailAttributes;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(AppString.player1Text,
                  style: AppStyles.h4(family: "Schuyler")),
              SizedBox(height: 10.h),
              Obx(() {
                final player1List = _createChallengeController
                  ...
                  onChanged: (newValue) {
                    setState(
                      () {
                        ...
                        print(
                            'Tournament Name>>>${_createChallengeController.player1}');
                      },
                    );
                  },
                );
              ...
              /// Player 2
              SizedBox(height: 10.h),
              Text(AppString.player2Text,
                  style: AppStyles.h4(family: "Schuyler")),
              SizedBox(height: 10.h),
              Obx(() {
                final player2List = _createChallengeController
                        .tournamentPlayerListModel
                        .value
                        .data
                        ?.attributes
                  ...
                  onChanged: (newValue) {
                    setState(
                      () {
                        ...
                        print(
                            'Tournament Name>>>${_createChallengeController.player2}');
                      },
                    );
                  },
                );
              ...
              Obx(() {
                return CustomButton(
                    ...
                    onTap: () async {
                      if (tournamentDetailAttributes != null) {
                        await _createChallengeController.createChallenge(
                            tournamentDetailAttributes!, () async {
