...
class _TournamentDetailViewState extends State<TournamentDetailView> {
  final GaggleDetailController _tournamentDetailController =
      Get.put(GaggleDetailController());

  final TournamentCompletionStatus _tournamentCompletionStatus =
      Get.put(TournamentCompletionStatus());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          AppString.tournamentDetailText,
          style: AppStyles.h2(),
        ),
        centerTitle: true,
      ),
      body: Center(
        child: Padding(
          ...
          child: Obx(() {
            final tournamentDetailAttributes = _tournamentDetailController
                .tournamentDetailModel.value.data?.attributes;
            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                  if (tournamentDetailAttributes.tournamentCreator?.sId ==
                      _tournamentDetailController.myID)
                    ListTile(
                        title: Text(
                        ...
                        trailing: Switch(
                            value: isActive ??
                                tournamentDetailAttributes.isCompleted!,
                            activeColor: AppColors.primaryColor,
                            onChanged: (value) async {
                              if (value) {
                                await _tournamentCompletionStatus.changeStatus(
                  ...
                  CustomCard(
                    children: [
                      CustomNetworkImage(
                        imageUrl:
                            '${ApiConstants.imageBaseUrl}/${tournamentDetailAttributes.tournamentImage?.url}',
                        height: 180.h,
                                  ...
                                  child: ListTile(
                                    subtitle: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 6.h),
                                        Text(
                                            'Gaggle : ${tournamentDetailAttributes.clubName ?? tournamentDetailAttributes.tournamentName}',
                                            style: AppStyles.h5()),
                                        SizedBox(height: 6.h),
                                        Text(
                                            'Type : ${tournamentDetailAttributes.tournamentType}',
                                            style: AppStyles.h5()),
                                        // SizedBox(height: 6.h),
                                        // Text('Tee Time : 00:00', style: AppStyles.h5()),
                                        SizedBox(height: 6.h),
                                        Text(
                                            'Location : ${tournamentDetailAttributes.courseName} ',
                                            style: AppStyles.h5()),
                                      ],
                                    ),
                                  ),
                                    ...
                                    subtitle: Column(
                                      ...
                                      children: [
                                        AppButton(
                                            ...
                                            text:
                                                'Players : ${tournamentDetailAttributes.tournamentPlayersList?.length}/${tournamentDetailAttributes.numberOfPlayers}',
                                            height: 50.h),
                                        SizedBox(height: 6.h),
                                        Text(
                                            'Start Date : ${tournamentDetailAttributes.date}',
                                            style: AppStyles.h5()),
                                        SizedBox(height: 6.h),
                                        Text(
                                            'Start Time : ${tournamentDetailAttributes.time}',
                      ...
                      if (_tournamentDetailController.myID !=
                          tournamentDetailAttributes.tournamentCreator?.sId)
                        Obx(() {
                          ...
                          return AppButton(
                              ...
                              text:
                                  'Chat with ${tournamentDetailAttributes.tournamentCreator?.name}',
                              height: 50.h);
                        }),
                      ...
                      AppButton(
                          onTab: () {
                            String? tournamentName =
                                tournamentDetailAttributes.clubName ??
                                    tournamentDetailAttributes.tournamentName;
                            tournamentDetailAttributes.typeName;
                  ...
                  if (_tournamentDetailController.myID ==
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        CustomButton(
                            onTap: () {
                              Get.toNamed(Routes.ASSIGN_GROUP, arguments: {
                                'tournamentId': tournamentDetailAttributes.sId
                              });
                            },
                            text: 'Assign group'),
                  ...
                  CustomButton(
                      onTap: () {
                        Get.toNamed(Routes.CHALLENGE_MATCHES, arguments: {
                          'tournamentDetailsAttributes':
                              tournamentDetailAttributes
                        });
                      },
  ...
  void _showAppRovedPlayerBottomSheet(
      BuildContext context, List<TournamentPlayersList> playerList) {
    showModalBottomSheet(
      context: context,
      isScrollControlled:
          true, // This makes sure the bottom sheet height can be controlled
          ...
          child: Container(
            ...
            child: Column(
              mainAxisSize: MainAxisSize
                  .min, // This ensures the content takes minimum space
